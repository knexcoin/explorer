 ...
 * - If no saved preference AND no system preference, defaults to LIGHT
...
const KnexTheme = {
    init() {
        ...
        // 2. Determine theme: saved preference or default to light
        let theme;
        if (saved) {
            theme = saved;
        } else {
    ...
    apply(theme) {
        ...
        if (metaTheme) {
            metaTheme.content = theme === 'light' ? '#f8f8f8' : '#000000';
        }
